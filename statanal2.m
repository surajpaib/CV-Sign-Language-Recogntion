...
for i=1:12
G1(:,:,i)=xlsread(['C:\Users\Suraj\OneDrive\Documents\8th Sem\Repository\Pritika\Gesture1\variant',num2str(i),'.xls'],'A3:C12');
end
for i=1:15
...
for i=1:12
G2(:,:,i)=xlsread(['C:\Users\Suraj\OneDrive\Documents\8th Sem\Repository\Pritika\Gesture2\variant',num2str(i),'.xls'],'A3:C12');   
end
for i=1:7
...
for i=1:12
    G3(:,:,i)=xlsread(['C:\Users\Suraj\OneDrive\Documents\8th Sem\Repository\Pritika\Gesture3\variant',num2str(i),'.xls'],'A3:C12');  
end
for i=1:5
